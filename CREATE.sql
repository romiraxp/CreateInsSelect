...
create table if not exists tracks (
	...
	track_time time not null--продолжительность трека
);
...
create table if not exists collection (
	...
	collection_year date not null check(collection_year > '2000-01-01' and collection_year < '2024-01-01') --дата выхода сборника
);
